...
local CiderRunMode = {};CiderRunMode.runmode = 'DEBUG';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/BuddyD/Library/Application Support/luaglider2/dev";local SOCKET_PORT=40289;local GLIDER_MAIN_FOLDER= "/Users/BuddyD/Apps/Pow-Wow";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
